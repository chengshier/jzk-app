<template>
  <view class="receive-page">
    ...
    <view v-if="detail" class="receive-content">
      ...
      <view class="table-head"><text>商品信息</text><text>应收</text><text>实收</text><text v-if="receiveMode==='exception'">破损</text></view>
